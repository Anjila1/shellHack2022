...
def AmazonPrime_main():
    ap_d1 = date(2022,5,5,)
    ap_d2 = date(2022,9,10)
    ap_result1 = diff_dates(ap_d2, ap_d1)
    print(f'''Alert! Last Activity For Amazon Prime was {ap_result1} days ago''''')
